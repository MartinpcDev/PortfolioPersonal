import Foto from '../assets/images/perfil.webp'
        ...
        <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
          ...
          <div className='flex flex-col justify-center gap-4 sm:flex-row'>
            ...
            >
              ...
              <span className='absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-150 bg-gray-600 group-hover:h-full ease' />
              <span className='absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-150 bg-gray-600 group-hover:h-full ease' />
              <span className='absolute inset-0 w-full duration-300 delay-300 bg-secundario opacity-0 group-hover:opacity-100' />
            ...
            >
              ...
              <span className='absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-150 bg-gray-600 group-hover:h-full ease' />
              <span className='absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-150 bg-gray-600 group-hover:h-full ease' />
              <span className='absolute inset-0 w-full h-full duration-300 delay-300 bg-secundario opacity-0 group-hover:opacity-100' />
              <span className='relative transition-colors duration-300 delay-150 group-hover:text-titulos ease'>
                Linkedln
              </span>
            </a>
